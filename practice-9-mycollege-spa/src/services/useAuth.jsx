...
const AuthProvider = ({children}) => {  // you may ignore the 'children is missing in props validation' error
    ...
    return (
        // Create the provider so that any component in our application can use the values that we are sending.
